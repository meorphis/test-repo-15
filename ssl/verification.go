...
// using that method.
func (r *VerificationService) Edit(ctx context.Context, zoneID string, certificatePackID string, body VerificationEditParams, opts ...option.RequestOption) (res *VerificationEditResponse, err error) {
...
func (r *VerificationService) Get(ctx context.Context, zoneID string, query VerificationGetParams, opts ...option.RequestOption) (res *[]Verification, err error) {
