...
func (r *UniversalSettingService) Edit(ctx context.Context, zoneID string, body UniversalSettingEditParams, opts ...option.RequestOption) (res *UniversalSSLSettings, err error) {
...
func (r *UniversalSettingService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *UniversalSSLSettings, err error) {
