...
func (r *AnalyticsService) List(ctx context.Context, accountID string, query AnalyticsListParams, opts ...option.RequestOption) (res *Schema, err error) {
...
func (r *AnalyticsService) Stored(ctx context.Context, accountID string, query AnalyticsStoredParams, opts ...option.RequestOption) (res *Components, err error) {
