...
func (r *PrioritizeService) Update(ctx context.Context, zoneID string, body PrioritizeUpdateParams, opts ...option.RequestOption) (res *[]CustomCertificate, err error) {
