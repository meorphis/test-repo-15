...
func (r *SinkholeService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[Sinkhole], err error) {
...
// List sinkholes owned by this account
func (r *SinkholeService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Sinkhole] {
