...
func (r *MiscategorizationService) New(ctx context.Context, accountID string, body MiscategorizationNewParams, opts ...option.RequestOption) (res *MiscategorizationNewResponseUnion, err error) {
