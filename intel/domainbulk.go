...
func (r *DomainBulkService) Get(ctx context.Context, accountID string, query DomainBulkGetParams, opts ...option.RequestOption) (res *[]DomainBulkGetResponse, err error) {
