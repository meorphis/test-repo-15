...
// Get Domain History
func (r *DomainHistoryService) Get(ctx context.Context, accountID string, query DomainHistoryGetParams, opts ...option.RequestOption) (res *[]DomainHistory, err error) {
