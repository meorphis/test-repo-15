...
func (r *IndicatorFeedPermissionService) New(ctx context.Context, accountID string, body IndicatorFeedPermissionNewParams, opts ...option.RequestOption) (res *IndicatorFeedPermissionNewResponse, err error) {
...
func (r *IndicatorFeedPermissionService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *[]IndicatorFeedPermissionListResponse, err error) {
...
func (r *IndicatorFeedPermissionService) Delete(ctx context.Context, accountID string, body IndicatorFeedPermissionDeleteParams, opts ...option.RequestOption) (res *IndicatorFeedPermissionDeleteResponse, err error) {
