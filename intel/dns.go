...
func (r *DNSService) List(ctx context.Context, accountID string, query DNSListParams, opts ...option.RequestOption) (res *pagination.V4PagePagination[DNSListResponse], err error) {
...
// Get Passive DNS by IP
func (r *DNSService) ListAutoPaging(ctx context.Context, accountID string, query DNSListParams, opts ...option.RequestOption) *pagination.V4PagePaginationAutoPager[DNSListResponse] {
