...
func (r *IndicatorFeedSnapshotService) Update(ctx context.Context, accountID string, feedID int64, body IndicatorFeedSnapshotUpdateParams, opts ...option.RequestOption) (res *IndicatorFeedSnapshotUpdateResponse, err error) {
