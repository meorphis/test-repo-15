...
func (r *IndicatorFeedService) New(ctx context.Context, accountID string, body IndicatorFeedNewParams, opts ...option.RequestOption) (res *IndicatorFeedNewResponse, err error) {
...
func (r *IndicatorFeedService) Update(ctx context.Context, accountID string, feedID int64, body IndicatorFeedUpdateParams, opts ...option.RequestOption) (res *IndicatorFeedUpdateResponse, err error) {
...
func (r *IndicatorFeedService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[IndicatorFeedListResponse], err error) {
...
// Get indicator feeds owned by this account
func (r *IndicatorFeedService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[IndicatorFeedListResponse] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Get indicator feed data
func (r *IndicatorFeedService) Data(ctx context.Context, accountID string, feedID int64, opts ...option.RequestOption) (res *string, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *IndicatorFeedService) Get(ctx context.Context, accountID string, feedID int64, opts ...option.RequestOption) (res *IndicatorFeedGetResponse, err error) {
