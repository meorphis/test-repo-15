...
func (r *AttackSurfaceReportIssueService) List(ctx context.Context, accountID string, query AttackSurfaceReportIssueListParams, opts ...option.RequestOption) (res *pagination.V4PagePagination[AttackSurfaceReportIssueListResponse], err error) {
...
// Get Security Center Issues
func (r *AttackSurfaceReportIssueService) ListAutoPaging(ctx context.Context, accountID string, query AttackSurfaceReportIssueListParams, opts ...option.RequestOption) *pagination.V4PagePaginationAutoPager[AttackSurfaceReportIssueListResponse] {
	return pagination.NewV4PagePaginationAutoPager(r.List(ctx, accountID, query, opts...))
}

// Get Security Center Issue Counts by Class
func (r *AttackSurfaceReportIssueService) Class(ctx context.Context, accountID string, query AttackSurfaceReportIssueClassParams, opts ...option.RequestOption) (res *[]AttackSurfaceReportIssueClassResponse, err error) {
...
func (r *AttackSurfaceReportIssueService) Dismiss(ctx context.Context, accountID string, issueID string, body AttackSurfaceReportIssueDismissParams, opts ...option.RequestOption) (res *AttackSurfaceReportIssueDismissResponseUnion, err error) {
...
func (r *AttackSurfaceReportIssueService) Severity(ctx context.Context, accountID string, query AttackSurfaceReportIssueSeverityParams, opts ...option.RequestOption) (res *[]AttackSurfaceReportIssueSeverityResponse, err error) {
...
func (r *AttackSurfaceReportIssueService) Type(ctx context.Context, accountID string, query AttackSurfaceReportIssueTypeParams, opts ...option.RequestOption) (res *[]AttackSurfaceReportIssueTypeResponse, err error) {
