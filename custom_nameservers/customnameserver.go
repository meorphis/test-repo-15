...
func (r *CustomNameserverService) New(ctx context.Context, accountID string, body CustomNameserverNewParams, opts ...option.RequestOption) (res *CustomNameserver, err error) {
...
func (r *CustomNameserverService) Get(ctx context.Context, accountID string, opts ...option.RequestOption) (res *[]CustomNameserver, err error) {
