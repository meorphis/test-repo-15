...
func (r *DEXTestUniqueDeviceService) List(ctx context.Context, accountID string, query DEXTestUniqueDeviceListParams, opts ...option.RequestOption) (res *UniqueDevices, err error) {
