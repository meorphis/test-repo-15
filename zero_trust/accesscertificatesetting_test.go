...
func TestAccessCertificateSettingUpdate(t *testing.T) {
	...
	_, err := client.ZeroTrust.Access.Certificates.Settings.Update(
		context.TODO(),
		"account_or_zone",
...
func TestAccessCertificateSettingGet(t *testing.T) {
	t.Skip("TODO: investigate broken test")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ZeroTrust.Access.Certificates.Settings.Get(
		context.TODO(),
		"account_or_zone",
		"023e105f4ecef8ad9ca31a8372d0c353",
	)
