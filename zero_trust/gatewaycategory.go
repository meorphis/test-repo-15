...
func (r *GatewayCategoryService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[Category], err error) {
...
// Fetches a list of all categories.
func (r *GatewayCategoryService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Category] {
