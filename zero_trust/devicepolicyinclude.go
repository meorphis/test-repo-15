...
func (r *DevicePolicyIncludeService) Update(ctx context.Context, accountID string, body DevicePolicyIncludeUpdateParams, opts ...option.RequestOption) (res *[]SplitTunnelInclude, err error) {
...
func (r *DevicePolicyIncludeService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[SplitTunnelInclude], err error) {
...
// Fetches the list of routes included in the WARP client's tunnel.
func (r *DevicePolicyIncludeService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[SplitTunnelInclude] {
...
func (r *DevicePolicyIncludeService) Get(ctx context.Context, accountID string, policyID string, opts ...option.RequestOption) (res *[]SplitTunnelInclude, err error) {
