...
func (r *RiskScoringIntegrationReferenceService) Get(ctx context.Context, accountID string, referenceID string, opts ...option.RequestOption) (res *RiskScoringIntegrationReferenceGetResponse, err error) {
