...
func TestDevicePostureIntegrationNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Posture.Integrations.New(
		context.TODO(),
...
func TestDevicePostureIntegrationList(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Posture.Integrations.List(context.TODO(), "699d98642c564d2e855e9661899b7252")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
