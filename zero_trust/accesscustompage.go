...
func (r *AccessCustomPageService) New(ctx context.Context, accountID string, body AccessCustomPageNewParams, opts ...option.RequestOption) (res *CustomPageWithoutHTML, err error) {
...
func (r *AccessCustomPageService) Update(ctx context.Context, accountID string, customPageID string, body AccessCustomPageUpdateParams, opts ...option.RequestOption) (res *CustomPageWithoutHTML, err error) {
...
// List custom pages
func (r *AccessCustomPageService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[CustomPageWithoutHTML], err error) {
...
// List custom pages
func (r *AccessCustomPageService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[CustomPageWithoutHTML] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Delete a custom page
func (r *AccessCustomPageService) Delete(ctx context.Context, accountID string, customPageID string, opts ...option.RequestOption) (res *AccessCustomPageDeleteResponse, err error) {
...
func (r *AccessCustomPageService) Get(ctx context.Context, accountID string, customPageID string, opts ...option.RequestOption) (res *CustomPage, err error) {
