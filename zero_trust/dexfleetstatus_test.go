...
func TestDEXFleetStatusLive(t *testing.T) {
	...
	_, err := client.ZeroTrust.DEX.FleetStatus.Live(
		context.TODO(),
		"01a7362d577a6c3019a474fd6f485823",
		zero_trust.DEXFleetStatusLiveParams{
...
func TestDEXFleetStatusOverTimeWithOptionalParams(t *testing.T) {
	...
	err := client.ZeroTrust.DEX.FleetStatus.OverTime(
		context.TODO(),
		"01a7362d577a6c3019a474fd6f485823",
		zero_trust.DEXFleetStatusOverTimeParams{
