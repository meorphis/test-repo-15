...
func (r *AccessApplicationUserPolicyCheckService) List(ctx context.Context, accountOrZone string, accountOrZoneID string, appID AppIDParam, opts ...option.RequestOption) (res *AccessApplicationUserPolicyCheckListResponse, err error) {
