...
func (r *DevicePostureIntegrationService) New(ctx context.Context, accountID string, body DevicePostureIntegrationNewParams, opts ...option.RequestOption) (res *Integration, err error) {
...
func (r *DevicePostureIntegrationService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[Integration], err error) {
...
// Fetches the list of device posture integrations for an account.
func (r *DevicePostureIntegrationService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Integration] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Delete a configured device posture integration.
func (r *DevicePostureIntegrationService) Delete(ctx context.Context, accountID string, integrationID string, opts ...option.RequestOption) (res *DevicePostureIntegrationDeleteResponseUnion, err error) {
...
func (r *DevicePostureIntegrationService) Edit(ctx context.Context, accountID string, integrationID string, body DevicePostureIntegrationEditParams, opts ...option.RequestOption) (res *Integration, err error) {
...
func (r *DevicePostureIntegrationService) Get(ctx context.Context, accountID string, integrationID string, opts ...option.RequestOption) (res *Integration, err error) {
