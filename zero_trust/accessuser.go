...
func (r *AccessUserService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[AccessUser], err error) {
...
// Gets a list of users for an account.
func (r *AccessUserService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[AccessUser] {
