...
// days.
func (r *DEXHTTPTestPercentileService) Get(ctx context.Context, accountID string, testID string, query DEXHTTPTestPercentileGetParams, opts ...option.RequestOption) (res *HTTPDetailsPercentiles, err error) {
