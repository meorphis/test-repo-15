...
func TestDevicePolicyIncludeUpdate(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Policies.Includes.Update(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		zero_trust.DevicePolicyIncludeUpdateParams{
...
func TestDevicePolicyIncludeList(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Policies.Includes.List(context.TODO(), "699d98642c564d2e855e9661899b7252")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
