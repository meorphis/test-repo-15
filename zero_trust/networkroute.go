...
func (r *NetworkRouteService) New(ctx context.Context, accountID string, body NetworkRouteNewParams, opts ...option.RequestOption) (res *Route, err error) {
...
func (r *NetworkRouteService) List(ctx context.Context, accountID string, query NetworkRouteListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[Teamnet], err error) {
...
// Lists and filters private network routes in an account.
func (r *NetworkRouteService) ListAutoPaging(ctx context.Context, accountID string, query NetworkRouteListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[Teamnet] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, accountID, query, opts...))
}

// Deletes a private network route from an account.
func (r *NetworkRouteService) Delete(ctx context.Context, accountID string, routeID string, opts ...option.RequestOption) (res *Route, err error) {
...
func (r *NetworkRouteService) Edit(ctx context.Context, accountID string, routeID string, body NetworkRouteEditParams, opts ...option.RequestOption) (res *Route, err error) {
