...
func (r *DevicePostureService) New(ctx context.Context, accountID string, body DevicePostureNewParams, opts ...option.RequestOption) (res *DevicePostureRule, err error) {
...
func (r *DevicePostureService) Update(ctx context.Context, accountID string, ruleID string, body DevicePostureUpdateParams, opts ...option.RequestOption) (res *DevicePostureRule, err error) {
...
func (r *DevicePostureService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[DevicePostureRule], err error) {
...
// Fetches device posture rules for a Zero Trust account.
func (r *DevicePostureService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[DevicePostureRule] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Deletes a device posture rule.
func (r *DevicePostureService) Delete(ctx context.Context, accountID string, ruleID string, opts ...option.RequestOption) (res *DevicePostureDeleteResponse, err error) {
...
func (r *DevicePostureService) Get(ctx context.Context, accountID string, ruleID string, opts ...option.RequestOption) (res *DevicePostureRule, err error) {
