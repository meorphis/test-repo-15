...
func (r *AccessUserActiveSessionService) List(ctx context.Context, accountID string, userID string, opts ...option.RequestOption) (res *pagination.SinglePage[AccessUserActiveSessionListResponse], err error) {
...
// Get active sessions for a single user.
func (r *AccessUserActiveSessionService) ListAutoPaging(ctx context.Context, accountID string, userID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[AccessUserActiveSessionListResponse] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, userID, opts...))
}

// Get an active session for a single user.
func (r *AccessUserActiveSessionService) Get(ctx context.Context, accountID string, userID string, nonce string, opts ...option.RequestOption) (res *AccessUserActiveSessionGetResponse, err error) {
