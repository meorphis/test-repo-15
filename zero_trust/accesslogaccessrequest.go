...
func (r *AccessLogAccessRequestService) List(ctx context.Context, accountID string, query AccessLogAccessRequestListParams, opts ...option.RequestOption) (res *[]AccessRequests, err error) {
