...
func (r *GatewayConfigurationService) Update(ctx context.Context, accountID string, body GatewayConfigurationUpdateParams, opts ...option.RequestOption) (res *GatewayConfigurationUpdateResponse, err error) {
...
func (r *GatewayConfigurationService) Edit(ctx context.Context, accountID string, body GatewayConfigurationEditParams, opts ...option.RequestOption) (res *GatewayConfigurationEditResponse, err error) {
...
func (r *GatewayConfigurationService) Get(ctx context.Context, accountID string, opts ...option.RequestOption) (res *GatewayConfigurationGetResponse, err error) {
