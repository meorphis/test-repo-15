...
func (r *DevicePolicyExcludeService) Update(ctx context.Context, accountID string, body DevicePolicyExcludeUpdateParams, opts ...option.RequestOption) (res *[]SplitTunnelExclude, err error) {
...
func (r *DevicePolicyExcludeService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[SplitTunnelExclude], err error) {
...
// Fetches the list of routes excluded from the WARP client's tunnel.
func (r *DevicePolicyExcludeService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[SplitTunnelExclude] {
...
func (r *DevicePolicyExcludeService) Get(ctx context.Context, accountID string, policyID string, opts ...option.RequestOption) (res *[]SplitTunnelExclude, err error) {
