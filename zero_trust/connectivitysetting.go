...
func (r *ConnectivitySettingService) Edit(ctx context.Context, accountID string, body ConnectivitySettingEditParams, opts ...option.RequestOption) (res *ConnectivitySettingEditResponse, err error) {
...
func (r *ConnectivitySettingService) Get(ctx context.Context, accountID string, opts ...option.RequestOption) (res *ConnectivitySettingGetResponse, err error) {
