...
func TestGatewayAuditSSHSettingUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Gateway.AuditSSHSettings.Update(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		zero_trust.GatewayAuditSSHSettingUpdateParams{
...
func TestGatewayAuditSSHSettingGet(t *testing.T) {
	...
	_, err := client.ZeroTrust.Gateway.AuditSSHSettings.Get(context.TODO(), "699d98642c564d2e855e9661899b7252")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
