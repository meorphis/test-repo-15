...
func TestDevicePolicyExcludeUpdate(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Policies.Excludes.Update(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		zero_trust.DevicePolicyExcludeUpdateParams{
...
func TestDevicePolicyExcludeList(t *testing.T) {
	...
	_, err := client.ZeroTrust.Devices.Policies.Excludes.List(context.TODO(), "699d98642c564d2e855e9661899b7252")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
