...
func (r *AccessPolicyService) New(ctx context.Context, accountID string, body AccessPolicyNewParams, opts ...option.RequestOption) (res *AccessPolicyNewResponse, err error) {
...
func (r *AccessPolicyService) Update(ctx context.Context, accountID string, policyID string, body AccessPolicyUpdateParams, opts ...option.RequestOption) (res *AccessPolicyUpdateResponse, err error) {
...
func (r *AccessPolicyService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[AccessPolicyListResponse], err error) {
...
// Lists Access reusable policies.
func (r *AccessPolicyService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[AccessPolicyListResponse] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Deletes an Access reusable policy.
func (r *AccessPolicyService) Delete(ctx context.Context, accountID string, policyID string, opts ...option.RequestOption) (res *AccessPolicyDeleteResponse, err error) {
...
func (r *AccessPolicyService) Get(ctx context.Context, accountID string, policyID string, opts ...option.RequestOption) (res *AccessPolicyGetResponse, err error) {
