...
// List DEX tests
func (r *DEXTestService) List(ctx context.Context, accountID string, query DEXTestListParams, opts ...option.RequestOption) (res *pagination.V4PagePagination[DEXTestListResponse], err error) {
...
// List DEX tests
func (r *DEXTestService) ListAutoPaging(ctx context.Context, accountID string, query DEXTestListParams, opts ...option.RequestOption) *pagination.V4PagePaginationAutoPager[DEXTestListResponse] {
