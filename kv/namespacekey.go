...
func (r *NamespaceKeyService) List(ctx context.Context, accountID string, namespaceID string, query NamespaceKeyListParams, opts ...option.RequestOption) (res *pagination.CursorLimitPagination[Key], err error) {
...
// Lists a namespace's keys.
func (r *NamespaceKeyService) ListAutoPaging(ctx context.Context, accountID string, namespaceID string, query NamespaceKeyListParams, opts ...option.RequestOption) *pagination.CursorLimitPaginationAutoPager[Key] {
	return pagination.NewCursorLimitPaginationAutoPager(r.List(ctx, accountID, namespaceID, query, opts...))
}
