...
func (r *NamespaceValueService) Update(ctx context.Context, accountID string, namespaceID string, keyName string, body NamespaceValueUpdateParams, opts ...option.RequestOption) (res *NamespaceValueUpdateResponse, err error) {
...
func (r *NamespaceValueService) Delete(ctx context.Context, accountID string, namespaceID string, keyName string, opts ...option.RequestOption) (res *NamespaceValueDeleteResponse, err error) {
...
// response header.
func (r *NamespaceValueService) Get(ctx context.Context, accountID string, namespaceID string, keyName string, opts ...option.RequestOption) (res *http.Response, err error) {
	opts = append(r.Options[:], opts...)
