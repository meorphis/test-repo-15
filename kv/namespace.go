...
// to be replaced.
func (r *NamespaceService) New(ctx context.Context, accountID string, body NamespaceNewParams, opts ...option.RequestOption) (res *Namespace, err error) {
...
func (r *NamespaceService) Update(ctx context.Context, accountID string, namespaceID string, body NamespaceUpdateParams, opts ...option.RequestOption) (res *NamespaceUpdateResponse, err error) {
...
func (r *NamespaceService) List(ctx context.Context, accountID string, query NamespaceListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[Namespace], err error) {
...
// Returns the namespaces owned by an account.
func (r *NamespaceService) ListAutoPaging(ctx context.Context, accountID string, query NamespaceListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[Namespace] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, accountID, query, opts...))
}

// Deletes the namespace corresponding to the given ID.
func (r *NamespaceService) Delete(ctx context.Context, accountID string, namespaceID string, opts ...option.RequestOption) (res *NamespaceDeleteResponse, err error) {
...
func (r *NamespaceService) Get(ctx context.Context, accountID string, namespaceID string, opts ...option.RequestOption) (res *Namespace, err error) {
