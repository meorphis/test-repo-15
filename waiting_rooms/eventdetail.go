...
func (r *EventDetailService) Get(ctx context.Context, zoneID string, waitingRoomID string, eventID string, opts ...option.RequestOption) (res *EventDetailGetResponse, err error) {
