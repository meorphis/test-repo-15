...
func (r *EventService) New(ctx context.Context, zoneID string, waitingRoomID string, body EventNewParams, opts ...option.RequestOption) (res *Event, err error) {
...
func (r *EventService) Update(ctx context.Context, zoneID string, waitingRoomID string, eventID string, body EventUpdateParams, opts ...option.RequestOption) (res *Event, err error) {
...
func (r *EventService) List(ctx context.Context, zoneID string, waitingRoomID string, query EventListParams, opts ...option.RequestOption) (res *pagination.SinglePage[Event], err error) {
...
// Lists events for a waiting room.
func (r *EventService) ListAutoPaging(ctx context.Context, zoneID string, waitingRoomID string, query EventListParams, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Event] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, waitingRoomID, query, opts...))
}

// Deletes an event for a waiting room.
func (r *EventService) Delete(ctx context.Context, zoneID string, waitingRoomID string, eventID string, opts ...option.RequestOption) (res *EventDeleteResponse, err error) {
...
func (r *EventService) Edit(ctx context.Context, zoneID string, waitingRoomID string, eventID string, body EventEditParams, opts ...option.RequestOption) (res *Event, err error) {
...
func (r *EventService) Get(ctx context.Context, zoneID string, waitingRoomID string, eventID string, opts ...option.RequestOption) (res *Event, err error) {
