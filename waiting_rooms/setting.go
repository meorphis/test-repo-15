...
func (r *SettingService) Update(ctx context.Context, zoneID string, body SettingUpdateParams, opts ...option.RequestOption) (res *SettingUpdateResponse, err error) {
...
func (r *SettingService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *SettingGetResponse, err error) {
