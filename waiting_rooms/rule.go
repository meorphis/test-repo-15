...
// waiting room.
func (r *RuleService) New(ctx context.Context, zoneID string, waitingRoomID string, body RuleNewParams, opts ...option.RequestOption) (res *[]WaitingRoomRule, err error) {
...
// for a waiting room.
func (r *RuleService) Update(ctx context.Context, zoneID string, waitingRoomID string, body RuleUpdateParams, opts ...option.RequestOption) (res *[]WaitingRoomRule, err error) {
...
func (r *RuleService) List(ctx context.Context, zoneID string, waitingRoomID string, opts ...option.RequestOption) (res *pagination.SinglePage[WaitingRoomRule], err error) {
...
// Lists rules for a waiting room.
func (r *RuleService) ListAutoPaging(ctx context.Context, zoneID string, waitingRoomID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[WaitingRoomRule] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, waitingRoomID, opts...))
}

// Deletes a rule for a waiting room.
func (r *RuleService) Delete(ctx context.Context, zoneID string, waitingRoomID string, ruleID string, opts ...option.RequestOption) (res *[]WaitingRoomRule, err error) {
...
func (r *RuleService) Edit(ctx context.Context, zoneID string, waitingRoomID string, ruleID string, body RuleEditParams, opts ...option.RequestOption) (res *[]WaitingRoomRule, err error) {
