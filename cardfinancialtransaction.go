...
// with interacting with the meorphis-test-43 API.
//
...
func (r FinancialTransactionCategory) IsKnown() bool {
	switch r {
	case FinancialTransactionCategoryCard, FinancialTransactionCategoryACH, FinancialTransactionCategoryTransfer:
		return true
	}
	return false
}
