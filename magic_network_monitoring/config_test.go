...
func TestConfigNew(t *testing.T) {
	...
	_, err := client.MagicNetworkMonitoring.Configs.New(
		context.TODO(),
...
func TestConfigUpdate(t *testing.T) {
	...
	_, err := client.MagicNetworkMonitoring.Configs.Update(
		context.TODO(),
		"6f91088a406011ed95aed352566e8d4c",
...
func TestConfigEdit(t *testing.T) {
	...
	_, err := client.MagicNetworkMonitoring.Configs.Edit(
		context.TODO(),
		"6f91088a406011ed95aed352566e8d4c",
		magic_network_monitoring.ConfigEditParams{
			Body: map[string]interface{}{},
		},
	)
	if err != nil {
