...
func (r *RuleService) New(ctx context.Context, accountID string, body RuleNewParams, opts ...option.RequestOption) (res *MagicNetworkMonitoringRule, err error) {
...
func (r *RuleService) Update(ctx context.Context, accountID string, body RuleUpdateParams, opts ...option.RequestOption) (res *MagicNetworkMonitoringRule, err error) {
...
func (r *RuleService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[MagicNetworkMonitoringRule], err error) {
...
// Lists network monitoring rules for account.
func (r *RuleService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[MagicNetworkMonitoringRule] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Delete a network monitoring rule for account.
func (r *RuleService) Delete(ctx context.Context, accountID string, ruleID string, opts ...option.RequestOption) (res *MagicNetworkMonitoringRule, err error) {
...
func (r *RuleService) Edit(ctx context.Context, accountID string, ruleID string, body RuleEditParams, opts ...option.RequestOption) (res *MagicNetworkMonitoringRule, err error) {
...
func (r *RuleService) Get(ctx context.Context, accountID string, ruleID string, opts ...option.RequestOption) (res *MagicNetworkMonitoringRule, err error) {
