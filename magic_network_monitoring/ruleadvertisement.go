...
func (r *RuleAdvertisementService) Edit(ctx context.Context, accountID string, ruleID string, body RuleAdvertisementEditParams, opts ...option.RequestOption) (res *Advertisement, err error) {
