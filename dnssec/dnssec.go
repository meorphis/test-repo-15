...
// Delete DNSSEC.
func (r *DNSSECService) Delete(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *DNSSECDeleteResponseUnion, err error) {
...
func (r *DNSSECService) Edit(ctx context.Context, zoneID string, body DNSSECEditParams, opts ...option.RequestOption) (res *DNSSEC, err error) {
...
func (r *DNSSECService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *DNSSEC, err error) {
