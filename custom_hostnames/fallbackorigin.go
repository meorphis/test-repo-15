...
func (r *FallbackOriginService) Update(ctx context.Context, zoneID string, body FallbackOriginUpdateParams, opts ...option.RequestOption) (res *FallbackOriginUpdateResponseUnion, err error) {
...
func (r *FallbackOriginService) Delete(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *FallbackOriginDeleteResponseUnion, err error) {
...
func (r *FallbackOriginService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *FallbackOriginGetResponseUnion, err error) {
