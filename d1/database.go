...
func (r *DatabaseService) New(ctx context.Context, accountID string, body DatabaseNewParams, opts ...option.RequestOption) (res *DatabaseNewResponse, err error) {
...
func (r *DatabaseService) List(ctx context.Context, accountID string, query DatabaseListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[DatabaseListResponse], err error) {
...
// Returns a list of D1 databases.
func (r *DatabaseService) ListAutoPaging(ctx context.Context, accountID string, query DatabaseListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[DatabaseListResponse] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, accountID, query, opts...))
}

// Deletes the specified D1 database.
func (r *DatabaseService) Delete(ctx context.Context, accountID string, databaseID string, opts ...option.RequestOption) (res *DatabaseDeleteResponseUnion, err error) {
...
func (r *DatabaseService) Export(ctx context.Context, accountID string, databaseID string, body DatabaseExportParams, opts ...option.RequestOption) (res *DatabaseExportResponse, err error) {
...
func (r *DatabaseService) Get(ctx context.Context, accountID string, databaseID string, opts ...option.RequestOption) (res *D1, err error) {
...
// duration.
func (r *DatabaseService) Import(ctx context.Context, accountID string, databaseID string, body DatabaseImportParams, opts ...option.RequestOption) (res *DatabaseImportResponse, err error) {
...
func (r *DatabaseService) Query(ctx context.Context, accountID string, databaseID string, body DatabaseQueryParams, opts ...option.RequestOption) (res *[]QueryResult, err error) {
...
func (r *DatabaseService) Raw(ctx context.Context, accountID string, databaseID string, body DatabaseRawParams, opts ...option.RequestOption) (res *[]DatabaseRawResponse, err error) {
