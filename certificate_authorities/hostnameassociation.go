...
func (r *HostnameAssociationService) Update(ctx context.Context, zoneID string, body HostnameAssociationUpdateParams, opts ...option.RequestOption) (res *HostnameAssociationUpdateResponse, err error) {
...
func (r *HostnameAssociationService) Get(ctx context.Context, zoneID string, query HostnameAssociationGetParams, opts ...option.RequestOption) (res *HostnameAssociationGetResponse, err error) {
