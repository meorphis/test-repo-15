...
func TestOutgoingDisable(t *testing.T) {
	...
	_, err := client.SecondaryDNS.Outgoing.Disable(
		context.TODO(),
		"269d8f4853475ca241c4e730be286b20",
		secondary_dns.OutgoingDisableParams{
...
func TestOutgoingEnable(t *testing.T) {
	...
	_, err := client.SecondaryDNS.Outgoing.Enable(
		context.TODO(),
		"269d8f4853475ca241c4e730be286b20",
		secondary_dns.OutgoingEnableParams{
			Body: map[string]interface{}{},
		},
	)
	if err != nil {
...
func TestOutgoingForceNotify(t *testing.T) {
	...
	_, err := client.SecondaryDNS.Outgoing.ForceNotify(
		context.TODO(),
		"269d8f4853475ca241c4e730be286b20",
		secondary_dns.OutgoingForceNotifyParams{
			Body: map[string]interface{}{},
		},
	)
	if err != nil {
