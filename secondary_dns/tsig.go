...
// Create TSIG.
func (r *TSIGService) New(ctx context.Context, accountID string, body TSIGNewParams, opts ...option.RequestOption) (res *TSIG, err error) {
...
// Modify TSIG.
func (r *TSIGService) Update(ctx context.Context, accountID string, tsigID string, body TSIGUpdateParams, opts ...option.RequestOption) (res *TSIG, err error) {
...
// List TSIGs.
func (r *TSIGService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[TSIG], err error) {
...
// List TSIGs.
func (r *TSIGService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[TSIG] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Delete TSIG.
func (r *TSIGService) Delete(ctx context.Context, accountID string, tsigID string, opts ...option.RequestOption) (res *TSIGDeleteResponse, err error) {
...
// Get TSIG.
func (r *TSIGService) Get(ctx context.Context, accountID string, tsigID string, opts ...option.RequestOption) (res *TSIG, err error) {
