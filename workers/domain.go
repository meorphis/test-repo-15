...
func (r *DomainService) Update(ctx context.Context, accountID string, body DomainUpdateParams, opts ...option.RequestOption) (res *Domain, err error) {
...
func (r *DomainService) List(ctx context.Context, accountID string, query DomainListParams, opts ...option.RequestOption) (res *pagination.SinglePage[Domain], err error) {
...
// Lists all Worker Domains for an account.
func (r *DomainService) ListAutoPaging(ctx context.Context, accountID string, query DomainListParams, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Domain] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, query, opts...))
}

// Detaches a Worker from a zone and hostname.
func (r *DomainService) Delete(ctx context.Context, accountID string, domainID string, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
...
func (r *DomainService) Get(ctx context.Context, accountID string, domainID string, opts ...option.RequestOption) (res *Domain, err error) {
