...
func (r *ScriptTailService) New(ctx context.Context, accountID string, scriptName string, body ScriptTailNewParams, opts ...option.RequestOption) (res *ScriptTailNewResponse, err error) {
...
func (r *ScriptTailService) Delete(ctx context.Context, accountID string, scriptName string, id string, opts ...option.RequestOption) (res *ScriptTailDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
func (r *ScriptTailService) Get(ctx context.Context, accountID string, scriptName string, opts ...option.RequestOption) (res *ScriptTailGetResponse, err error) {
