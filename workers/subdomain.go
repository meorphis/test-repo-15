...
func (r *SubdomainService) Update(ctx context.Context, accountID string, body SubdomainUpdateParams, opts ...option.RequestOption) (res *SubdomainUpdateResponse, err error) {
...
func (r *SubdomainService) Get(ctx context.Context, accountID string, opts ...option.RequestOption) (res *SubdomainGetResponse, err error) {
