...
func (r *AIService) Run(ctx context.Context, accountID string, modelName string, body AIRunParams, opts ...option.RequestOption) (res *AIRunResponseUnion, err error) {
