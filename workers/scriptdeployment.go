...
// Worker.
func (r *ScriptDeploymentService) New(ctx context.Context, accountID string, scriptName string, params ScriptDeploymentNewParams, opts ...option.RequestOption) (res *ScriptDeploymentNewResponse, err error) {
...
func (r *ScriptDeploymentService) Get(ctx context.Context, accountID string, scriptName string, opts ...option.RequestOption) (res *ScriptDeploymentGetResponse, err error) {
