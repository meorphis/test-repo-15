...
func (r *ScriptSettingService) Edit(ctx context.Context, accountID string, scriptName string, body ScriptSettingEditParams, opts ...option.RequestOption) (res *ScriptSetting, err error) {
...
// [Worker Versions](https://developers.cloudflare.com/api/operations/worker-versions-list-versions).
// Includes Logpush and Tail Consumers.
func (r *ScriptSettingService) Get(ctx context.Context, accountID string, scriptName string, opts ...option.RequestOption) (res *ScriptSetting, err error) {
