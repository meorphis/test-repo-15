...
func (r *ScriptContentService) Update(ctx context.Context, accountID string, scriptName string, params ScriptContentUpdateParams, opts ...option.RequestOption) (res *Script, err error) {
...
func (r *ScriptContentService) Get(ctx context.Context, accountID string, scriptName string, opts ...option.RequestOption) (res *http.Response, err error) {
	opts = append(r.Options[:], opts...)
