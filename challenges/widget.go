...
func (r *WidgetService) New(ctx context.Context, accountID string, params WidgetNewParams, opts ...option.RequestOption) (res *Widget, err error) {
...
func (r *WidgetService) Update(ctx context.Context, accountID string, sitekey string, body WidgetUpdateParams, opts ...option.RequestOption) (res *Widget, err error) {
...
func (r *WidgetService) List(ctx context.Context, accountID string, query WidgetListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[WidgetListResponse], err error) {
...
// Lists all turnstile widgets of an account.
func (r *WidgetService) ListAutoPaging(ctx context.Context, accountID string, query WidgetListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[WidgetListResponse] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, accountID, query, opts...))
}

// Destroy a Turnstile Widget.
func (r *WidgetService) Delete(ctx context.Context, accountID string, sitekey string, opts ...option.RequestOption) (res *Widget, err error) {
...
func (r *WidgetService) Get(ctx context.Context, accountID string, sitekey string, opts ...option.RequestOption) (res *Widget, err error) {
...
func (r *WidgetService) RotateSecret(ctx context.Context, accountID string, sitekey string, body WidgetRotateSecretParams, opts ...option.RequestOption) (res *Widget, err error) {
