...
func (r *ProjectService) New(ctx context.Context, accountID string, body ProjectNewParams, opts ...option.RequestOption) (res *ProjectNewResponseUnion, err error) {
...
func (r *ProjectService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[Deployment], err error) {
...
// Fetch a list of all user projects.
func (r *ProjectService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Deployment] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Delete a project by name.
func (r *ProjectService) Delete(ctx context.Context, accountID string, projectName string, opts ...option.RequestOption) (res *ProjectDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
func (r *ProjectService) Edit(ctx context.Context, accountID string, projectName string, body ProjectEditParams, opts ...option.RequestOption) (res *ProjectEditResponseUnion, err error) {
...
func (r *ProjectService) Get(ctx context.Context, accountID string, projectName string, opts ...option.RequestOption) (res *Project, err error) {
...
func (r *ProjectService) PurgeBuildCache(ctx context.Context, accountID string, projectName string, opts ...option.RequestOption) (res *ProjectPurgeBuildCacheResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
