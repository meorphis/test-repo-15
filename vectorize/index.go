...
func (r *IndexService) New(ctx context.Context, accountID string, body IndexNewParams, opts ...option.RequestOption) (res *CreateIndex, err error) {
...
func (r *IndexService) Update(ctx context.Context, accountID string, indexName string, body IndexUpdateParams, opts ...option.RequestOption) (res *CreateIndex, err error) {
...
func (r *IndexService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[CreateIndex], err error) {
...
// Returns a list of Vectorize Indexes
func (r *IndexService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[CreateIndex] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Deletes the specified Vectorize Index.
func (r *IndexService) Delete(ctx context.Context, accountID string, indexName string, opts ...option.RequestOption) (res *IndexDeleteResponseUnion, err error) {
...
func (r *IndexService) DeleteByIDs(ctx context.Context, accountID string, indexName string, body IndexDeleteByIDsParams, opts ...option.RequestOption) (res *IndexDeleteVectorsByID, err error) {
...
func (r *IndexService) Get(ctx context.Context, accountID string, indexName string, opts ...option.RequestOption) (res *CreateIndex, err error) {
...
func (r *IndexService) GetByIDs(ctx context.Context, accountID string, indexName string, body IndexGetByIDsParams, opts ...option.RequestOption) (res *IndexGetByIDsResponse, err error) {
...
func (r *IndexService) Insert(ctx context.Context, accountID string, indexName string, body IndexInsertParams, opts ...option.RequestOption) (res *IndexInsert, err error) {
...
func (r *IndexService) Query(ctx context.Context, accountID string, indexName string, body IndexQueryParams, opts ...option.RequestOption) (res *IndexQuery, err error) {
...
func (r *IndexService) Upsert(ctx context.Context, accountID string, indexName string, body IndexUpsertParams, opts ...option.RequestOption) (res *IndexUpsert, err error) {
