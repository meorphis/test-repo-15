...
func (r *CookieService) List(ctx context.Context, zoneID string, query CookieListParams, opts ...option.RequestOption) (res *pagination.SinglePage[CookieListResponse], err error) {
...
// Lists all cookies collected by Page Shield.
func (r *CookieService) ListAutoPaging(ctx context.Context, zoneID string, query CookieListParams, opts ...option.RequestOption) *pagination.SinglePageAutoPager[CookieListResponse] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, query, opts...))
}

// Fetches a cookie collected by Page Shield by cookie ID.
func (r *CookieService) Get(ctx context.Context, zoneID string, cookieID string, opts ...option.RequestOption) (res *CookieGetResponse, err error) {
