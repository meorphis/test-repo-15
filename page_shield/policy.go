...
func (r *PolicyService) New(ctx context.Context, zoneID string, body PolicyNewParams, opts ...option.RequestOption) (res *PolicyNewResponse, err error) {
...
func (r *PolicyService) Update(ctx context.Context, zoneID string, policyID string, body PolicyUpdateParams, opts ...option.RequestOption) (res *PolicyUpdateResponse, err error) {
...
func (r *PolicyService) List(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *pagination.SinglePage[PolicyListResponse], err error) {
...
// Lists all Page Shield policies.
func (r *PolicyService) ListAutoPaging(ctx context.Context, zoneID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[PolicyListResponse] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, opts...))
}

// Delete a Page Shield policy by ID.
func (r *PolicyService) Delete(ctx context.Context, zoneID string, policyID string, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
...
func (r *PolicyService) Get(ctx context.Context, zoneID string, policyID string, opts ...option.RequestOption) (res *PolicyGetResponse, err error) {
