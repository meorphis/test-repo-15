...
func (r *ScriptService) List(ctx context.Context, zoneID string, query ScriptListParams, opts ...option.RequestOption) (res *pagination.SinglePage[Script], err error) {
...
// Lists all scripts detected by Page Shield.
func (r *ScriptService) ListAutoPaging(ctx context.Context, zoneID string, query ScriptListParams, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Script] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, query, opts...))
}

// Fetches a script detected by Page Shield by script ID.
func (r *ScriptService) Get(ctx context.Context, zoneID string, scriptID string, opts ...option.RequestOption) (res *ScriptGetResponse, err error) {
