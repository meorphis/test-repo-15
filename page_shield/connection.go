...
func (r *ConnectionService) List(ctx context.Context, zoneID string, query ConnectionListParams, opts ...option.RequestOption) (res *pagination.SinglePage[Connection], err error) {
...
// Lists all connections detected by Page Shield.
func (r *ConnectionService) ListAutoPaging(ctx context.Context, zoneID string, query ConnectionListParams, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Connection] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, query, opts...))
}

// Fetches a connection detected by Page Shield by connection ID.
func (r *ConnectionService) Get(ctx context.Context, zoneID string, connectionID string, opts ...option.RequestOption) (res *Connection, err error) {
