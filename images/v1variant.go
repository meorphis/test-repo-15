...
func (r *V1VariantService) New(ctx context.Context, accountID string, body V1VariantNewParams, opts ...option.RequestOption) (res *V1VariantNewResponse, err error) {
...
func (r *V1VariantService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *Variant, err error) {
...
func (r *V1VariantService) Delete(ctx context.Context, accountID string, variantID string, opts ...option.RequestOption) (res *V1VariantDeleteResponseUnion, err error) {
...
func (r *V1VariantService) Edit(ctx context.Context, accountID string, variantID string, body V1VariantEditParams, opts ...option.RequestOption) (res *V1VariantEditResponse, err error) {
...
func (r *V1VariantService) Get(ctx context.Context, accountID string, variantID string, opts ...option.RequestOption) (res *V1VariantGetResponse, err error) {
