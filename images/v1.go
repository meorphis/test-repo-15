...
func (r *V1Service) New(ctx context.Context, accountID string, body V1NewParams, opts ...option.RequestOption) (res *Image, err error) {
...
func (r *V1Service) List(ctx context.Context, accountID string, query V1ListParams, opts ...option.RequestOption) (res *pagination.V4PagePagination[V1ListResponse], err error) {
...
// List up to 100 images with one request. Use the optional parameters below to get
// a specific range of images.
func (r *V1Service) ListAutoPaging(ctx context.Context, accountID string, query V1ListParams, opts ...option.RequestOption) *pagination.V4PagePaginationAutoPager[V1ListResponse] {
...
func (r *V1Service) Delete(ctx context.Context, accountID string, imageID string, opts ...option.RequestOption) (res *V1DeleteResponseUnion, err error) {
...
func (r *V1Service) Edit(ctx context.Context, accountID string, imageID string, body V1EditParams, opts ...option.RequestOption) (res *Image, err error) {
...
func (r *V1Service) Get(ctx context.Context, accountID string, imageID string, opts ...option.RequestOption) (res *Image, err error) {
