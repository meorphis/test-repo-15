...
func (r *AIGatewayService) New(ctx context.Context, accountID string, body AIGatewayNewParams, opts ...option.RequestOption) (res *AIGatewayNewResponse, err error) {
...
// Update a Gateway
func (r *AIGatewayService) Update(ctx context.Context, accountID string, id string, body AIGatewayUpdateParams, opts ...option.RequestOption) (res *AIGatewayUpdateResponse, err error) {
...
// List Gateways
func (r *AIGatewayService) List(ctx context.Context, accountID string, query AIGatewayListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[AIGatewayListResponse], err error) {
...
// List Gateways
func (r *AIGatewayService) ListAutoPaging(ctx context.Context, accountID string, query AIGatewayListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[AIGatewayListResponse] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, accountID, query, opts...))
}

// Delete a Gateway
func (r *AIGatewayService) Delete(ctx context.Context, accountID string, id string, opts ...option.RequestOption) (res *AIGatewayDeleteResponse, err error) {
...
// Fetch a Gateway
func (r *AIGatewayService) Get(ctx context.Context, accountID string, id string, opts ...option.RequestOption) (res *AIGatewayGetResponse, err error) {
