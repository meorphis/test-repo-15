...
func (r *LiveInputService) New(ctx context.Context, accountID string, body LiveInputNewParams, opts ...option.RequestOption) (res *LiveInput, err error) {
...
func (r *LiveInputService) Update(ctx context.Context, accountID string, liveInputIdentifier string, body LiveInputUpdateParams, opts ...option.RequestOption) (res *LiveInput, err error) {
...
func (r *LiveInputService) List(ctx context.Context, accountID string, query LiveInputListParams, opts ...option.RequestOption) (res *LiveInputListResponse, err error) {
...
func (r *LiveInputService) Delete(ctx context.Context, accountID string, liveInputIdentifier string, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
...
func (r *LiveInputService) Get(ctx context.Context, accountID string, liveInputIdentifier string, opts ...option.RequestOption) (res *LiveInput, err error) {
