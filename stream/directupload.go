...
func (r *DirectUploadService) New(ctx context.Context, accountID string, params DirectUploadNewParams, opts ...option.RequestOption) (res *DirectUploadNewResponse, err error) {
