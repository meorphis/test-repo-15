...
func (r *CaptionLanguageService) New(ctx context.Context, accountID string, identifier string, language string, opts ...option.RequestOption) (res *Caption, err error) {
...
func (r *CaptionLanguageService) Update(ctx context.Context, accountID string, identifier string, language string, body CaptionLanguageUpdateParams, opts ...option.RequestOption) (res *Caption, err error) {
...
func (r *CaptionLanguageService) Delete(ctx context.Context, accountID string, identifier string, language string, opts ...option.RequestOption) (res *string, err error) {
...
func (r *CaptionLanguageService) Get(ctx context.Context, accountID string, identifier string, language string, opts ...option.RequestOption) (res *Caption, err error) {
