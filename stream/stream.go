...
// details.
func (r *StreamService) New(ctx context.Context, accountID string, params StreamNewParams, opts ...option.RequestOption) (err error) {
...
func (r *StreamService) List(ctx context.Context, accountID string, query StreamListParams, opts ...option.RequestOption) (res *pagination.SinglePage[Video], err error) {
...
// Lists up to 1000 videos from a single request. For a specific range, refer to
// the optional parameters.
func (r *StreamService) ListAutoPaging(ctx context.Context, accountID string, query StreamListParams, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Video] {
...
func (r *StreamService) Get(ctx context.Context, accountID string, identifier string, opts ...option.RequestOption) (res *Video, err error) {
