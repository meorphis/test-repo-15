...
// request.
func (r *WatermarkService) New(ctx context.Context, accountID string, body WatermarkNewParams, opts ...option.RequestOption) (res *Watermark, err error) {
...
func (r *WatermarkService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[Watermark], err error) {
...
// Lists all watermark profiles for an account.
func (r *WatermarkService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Watermark] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Deletes a watermark profile.
func (r *WatermarkService) Delete(ctx context.Context, accountID string, identifier string, opts ...option.RequestOption) (res *WatermarkDeleteResponseUnion, err error) {
...
func (r *WatermarkService) Get(ctx context.Context, accountID string, identifier string, opts ...option.RequestOption) (res *Watermark, err error) {
