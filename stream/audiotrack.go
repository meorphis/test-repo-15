...
func (r *AudioTrackService) Delete(ctx context.Context, accountID string, identifier string, audioIdentifier string, opts ...option.RequestOption) (res *AudioTrackDeleteResponseUnion, err error) {
...
func (r *AudioTrackService) Copy(ctx context.Context, accountID string, identifier string, body AudioTrackCopyParams, opts ...option.RequestOption) (res *Audio, err error) {
...
// `false`.
func (r *AudioTrackService) Edit(ctx context.Context, accountID string, identifier string, audioIdentifier string, body AudioTrackEditParams, opts ...option.RequestOption) (res *Audio, err error) {
...
func (r *AudioTrackService) Get(ctx context.Context, accountID string, identifier string, opts ...option.RequestOption) (res *[]Audio, err error) {
