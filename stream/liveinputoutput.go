...
func (r *LiveInputOutputService) New(ctx context.Context, accountID string, liveInputIdentifier string, body LiveInputOutputNewParams, opts ...option.RequestOption) (res *Output, err error) {
...
func (r *LiveInputOutputService) Update(ctx context.Context, accountID string, liveInputIdentifier string, outputIdentifier string, body LiveInputOutputUpdateParams, opts ...option.RequestOption) (res *Output, err error) {
...
func (r *LiveInputOutputService) List(ctx context.Context, accountID string, liveInputIdentifier string, opts ...option.RequestOption) (res *pagination.SinglePage[Output], err error) {
...
// Retrieves all outputs associated with a specified live input.
func (r *LiveInputOutputService) ListAutoPaging(ctx context.Context, accountID string, liveInputIdentifier string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Output] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, liveInputIdentifier, opts...))
}

// Deletes an output and removes it from the associated live input.
func (r *LiveInputOutputService) Delete(ctx context.Context, accountID string, liveInputIdentifier string, outputIdentifier string, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
