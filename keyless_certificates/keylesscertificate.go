...
func (r *KeylessCertificateService) New(ctx context.Context, zoneID string, body KeylessCertificateNewParams, opts ...option.RequestOption) (res *KeylessCertificate, err error) {
...
func (r *KeylessCertificateService) List(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *pagination.SinglePage[KeylessCertificate], err error) {
...
// List all Keyless SSL configurations for a given zone.
func (r *KeylessCertificateService) ListAutoPaging(ctx context.Context, zoneID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[KeylessCertificate] {
...
func (r *KeylessCertificateService) Edit(ctx context.Context, zoneID string, keylessCertificateID string, body KeylessCertificateEditParams, opts ...option.RequestOption) (res *KeylessCertificate, err error) {
...
func (r *KeylessCertificateService) Get(ctx context.Context, zoneID string, keylessCertificateID string, opts ...option.RequestOption) (res *KeylessCertificate, err error) {
