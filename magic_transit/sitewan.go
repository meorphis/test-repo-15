...
func (r *SiteWANService) New(ctx context.Context, accountID string, siteID string, body SiteWANNewParams, opts ...option.RequestOption) (res *[]WAN, err error) {
...
func (r *SiteWANService) Update(ctx context.Context, accountID string, siteID string, wanID string, body SiteWANUpdateParams, opts ...option.RequestOption) (res *WAN, err error) {
...
func (r *SiteWANService) List(ctx context.Context, accountID string, siteID string, opts ...option.RequestOption) (res *pagination.SinglePage[WAN], err error) {
...
// Lists Site WANs associated with an account.
func (r *SiteWANService) ListAutoPaging(ctx context.Context, accountID string, siteID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[WAN] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, siteID, opts...))
}

// Remove a specific Site WAN.
func (r *SiteWANService) Delete(ctx context.Context, accountID string, siteID string, wanID string, opts ...option.RequestOption) (res *WAN, err error) {
...
func (r *SiteWANService) Edit(ctx context.Context, accountID string, siteID string, wanID string, body SiteWANEditParams, opts ...option.RequestOption) (res *WAN, err error) {
...
func (r *SiteWANService) Get(ctx context.Context, accountID string, siteID string, wanID string, opts ...option.RequestOption) (res *WAN, err error) {
