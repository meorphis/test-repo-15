...
func (r *SiteLANService) New(ctx context.Context, accountID string, siteID string, body SiteLANNewParams, opts ...option.RequestOption) (res *[]LAN, err error) {
...
func (r *SiteLANService) Update(ctx context.Context, accountID string, siteID string, lanID string, body SiteLANUpdateParams, opts ...option.RequestOption) (res *LAN, err error) {
...
func (r *SiteLANService) List(ctx context.Context, accountID string, siteID string, opts ...option.RequestOption) (res *pagination.SinglePage[LAN], err error) {
...
// Lists Site LANs associated with an account.
func (r *SiteLANService) ListAutoPaging(ctx context.Context, accountID string, siteID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[LAN] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, siteID, opts...))
}

// Remove a specific Site LAN.
func (r *SiteLANService) Delete(ctx context.Context, accountID string, siteID string, lanID string, opts ...option.RequestOption) (res *LAN, err error) {
...
func (r *SiteLANService) Edit(ctx context.Context, accountID string, siteID string, lanID string, body SiteLANEditParams, opts ...option.RequestOption) (res *LAN, err error) {
...
func (r *SiteLANService) Get(ctx context.Context, accountID string, siteID string, lanID string, opts ...option.RequestOption) (res *LAN, err error) {
