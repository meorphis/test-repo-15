...
// Creates a new Site
func (r *SiteService) New(ctx context.Context, accountID string, body SiteNewParams, opts ...option.RequestOption) (res *Site, err error) {
...
func (r *SiteService) Update(ctx context.Context, accountID string, siteID string, body SiteUpdateParams, opts ...option.RequestOption) (res *Site, err error) {
...
func (r *SiteService) List(ctx context.Context, accountID string, query SiteListParams, opts ...option.RequestOption) (res *pagination.SinglePage[Site], err error) {
...
// return sites where connector_identifier matches either site.ConnectorID or
// site.SecondaryConnectorID.
func (r *SiteService) ListAutoPaging(ctx context.Context, accountID string, query SiteListParams, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Site] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, query, opts...))
}

// Remove a specific Site.
func (r *SiteService) Delete(ctx context.Context, accountID string, siteID string, opts ...option.RequestOption) (res *Site, err error) {
...
func (r *SiteService) Edit(ctx context.Context, accountID string, siteID string, body SiteEditParams, opts ...option.RequestOption) (res *Site, err error) {
...
// Get a specific Site.
func (r *SiteService) Get(ctx context.Context, accountID string, siteID string, opts ...option.RequestOption) (res *Site, err error) {
