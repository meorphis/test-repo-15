...
func (r *CfInterconnectService) Update(ctx context.Context, accountID string, cfInterconnectID string, body CfInterconnectUpdateParams, opts ...option.RequestOption) (res *CfInterconnectUpdateResponse, err error) {
...
func (r *CfInterconnectService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *CfInterconnectListResponse, err error) {
...
func (r *CfInterconnectService) Get(ctx context.Context, accountID string, cfInterconnectID string, opts ...option.RequestOption) (res *CfInterconnectGetResponse, err error) {
