...
// changes.
func (r *IPSECTunnelService) New(ctx context.Context, accountID string, body IPSECTunnelNewParams, opts ...option.RequestOption) (res *IPSECTunnelNewResponse, err error) {
...
func (r *IPSECTunnelService) Update(ctx context.Context, accountID string, ipsecTunnelID string, body IPSECTunnelUpdateParams, opts ...option.RequestOption) (res *IPSECTunnelUpdateResponse, err error) {
...
func (r *IPSECTunnelService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *IPSECTunnelListResponse, err error) {
...
// without persisting changes.
func (r *IPSECTunnelService) Delete(ctx context.Context, accountID string, ipsecTunnelID string, opts ...option.RequestOption) (res *IPSECTunnelDeleteResponse, err error) {
...
func (r *IPSECTunnelService) Get(ctx context.Context, accountID string, ipsecTunnelID string, opts ...option.RequestOption) (res *IPSECTunnelGetResponse, err error) {
...
// safe place.
func (r *IPSECTunnelService) PSKGenerate(ctx context.Context, accountID string, ipsecTunnelID string, body IPSECTunnelPSKGenerateParams, opts ...option.RequestOption) (res *IPSECTunnelPSKGenerateResponse, err error) {
