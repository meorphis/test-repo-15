...
func (r *GRETunnelService) New(ctx context.Context, accountID string, body GRETunnelNewParams, opts ...option.RequestOption) (res *GRETunnelNewResponse, err error) {
...
// parameter to only run validation without persisting changes.
func (r *GRETunnelService) Update(ctx context.Context, accountID string, greTunnelID string, body GRETunnelUpdateParams, opts ...option.RequestOption) (res *GRETunnelUpdateResponse, err error) {
...
func (r *GRETunnelService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *GRETunnelListResponse, err error) {
...
func (r *GRETunnelService) Delete(ctx context.Context, accountID string, greTunnelID string, opts ...option.RequestOption) (res *GRETunnelDeleteResponse, err error) {
...
func (r *GRETunnelService) Get(ctx context.Context, accountID string, greTunnelID string, opts ...option.RequestOption) (res *GRETunnelGetResponse, err error) {
