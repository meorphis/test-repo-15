...
func (r *SiteACLService) New(ctx context.Context, accountID string, siteID string, body SiteACLNewParams, opts ...option.RequestOption) (res *ACL, err error) {
...
func (r *SiteACLService) Update(ctx context.Context, accountID string, siteID string, aclID string, body SiteACLUpdateParams, opts ...option.RequestOption) (res *ACL, err error) {
...
func (r *SiteACLService) List(ctx context.Context, accountID string, siteID string, opts ...option.RequestOption) (res *pagination.SinglePage[ACL], err error) {
...
// Lists Site ACLs associated with an account.
func (r *SiteACLService) ListAutoPaging(ctx context.Context, accountID string, siteID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[ACL] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, siteID, opts...))
}

// Remove a specific Site ACL.
func (r *SiteACLService) Delete(ctx context.Context, accountID string, siteID string, aclID string, opts ...option.RequestOption) (res *ACL, err error) {
...
func (r *SiteACLService) Edit(ctx context.Context, accountID string, siteID string, aclID string, body SiteACLEditParams, opts ...option.RequestOption) (res *ACL, err error) {
...
func (r *SiteACLService) Get(ctx context.Context, accountID string, siteID string, aclID string, opts ...option.RequestOption) (res *ACL, err error) {
