...
// Replace Connector
func (r *ConnectorService) Update(ctx context.Context, accountID string, connectorID string, body ConnectorUpdateParams, opts ...option.RequestOption) (res *ConnectorUpdateResponse, err error) {
...
// List Connectors
func (r *ConnectorService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[ConnectorListResponse], err error) {
...
// List Connectors
func (r *ConnectorService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[ConnectorListResponse] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Update Connector
func (r *ConnectorService) Edit(ctx context.Context, accountID string, connectorID string, body ConnectorEditParams, opts ...option.RequestOption) (res *ConnectorEditResponse, err error) {
...
// Fetch Connector
func (r *ConnectorService) Get(ctx context.Context, accountID string, connectorID string, opts ...option.RequestOption) (res *ConnectorGetResponse, err error) {
