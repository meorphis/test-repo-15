...
func (r *HealthcheckService) New(ctx context.Context, zoneID string, body HealthcheckNewParams, opts ...option.RequestOption) (res *Healthcheck, err error) {
...
func (r *HealthcheckService) Update(ctx context.Context, zoneID string, healthcheckID string, body HealthcheckUpdateParams, opts ...option.RequestOption) (res *Healthcheck, err error) {
...
func (r *HealthcheckService) List(ctx context.Context, zoneID string, query HealthcheckListParams, opts ...option.RequestOption) (res *pagination.SinglePage[Healthcheck], err error) {
...
// List configured health checks.
func (r *HealthcheckService) ListAutoPaging(ctx context.Context, zoneID string, query HealthcheckListParams, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Healthcheck] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, query, opts...))
}

// Delete a health check.
func (r *HealthcheckService) Delete(ctx context.Context, zoneID string, healthcheckID string, opts ...option.RequestOption) (res *HealthcheckDeleteResponse, err error) {
...
func (r *HealthcheckService) Edit(ctx context.Context, zoneID string, healthcheckID string, body HealthcheckEditParams, opts ...option.RequestOption) (res *Healthcheck, err error) {
...
func (r *HealthcheckService) Get(ctx context.Context, zoneID string, healthcheckID string, opts ...option.RequestOption) (res *Healthcheck, err error) {
