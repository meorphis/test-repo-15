...
func (r *JobService) New(ctx context.Context, accountOrZone string, accountOrZoneID string, body JobNewParams, opts ...option.RequestOption) (res *LogpushJob, err error) {
...
func (r *JobService) Update(ctx context.Context, accountOrZone string, accountOrZoneID string, jobID int64, body JobUpdateParams, opts ...option.RequestOption) (res *LogpushJob, err error) {
...
func (r *JobService) List(ctx context.Context, accountOrZone string, accountOrZoneID string, opts ...option.RequestOption) (res *pagination.SinglePage[LogpushJob], err error) {
...
// Lists Logpush jobs for an account or zone.
func (r *JobService) ListAutoPaging(ctx context.Context, accountOrZone string, accountOrZoneID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[LogpushJob] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountOrZone, accountOrZoneID, opts...))
}

// Deletes a Logpush job.
func (r *JobService) Delete(ctx context.Context, accountOrZone string, accountOrZoneID string, jobID int64, opts ...option.RequestOption) (res *JobDeleteResponse, err error) {
...
func (r *JobService) Get(ctx context.Context, accountOrZone string, accountOrZoneID string, jobID int64, opts ...option.RequestOption) (res *LogpushJob, err error) {
