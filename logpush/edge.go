...
func (r *EdgeService) New(ctx context.Context, zoneID string, body EdgeNewParams, opts ...option.RequestOption) (res *InstantLogpushJob, err error) {
...
func (r *EdgeService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *[]InstantLogpushJob, err error) {
