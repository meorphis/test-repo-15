...
func (r *ValidateService) Destination(ctx context.Context, accountOrZone string, accountOrZoneID string, body ValidateDestinationParams, opts ...option.RequestOption) (res *ValidateDestinationResponse, err error) {
...
func (r *ValidateService) Origin(ctx context.Context, accountOrZone string, accountOrZoneID string, body ValidateOriginParams, opts ...option.RequestOption) (res *ValidateOriginResponse, err error) {
