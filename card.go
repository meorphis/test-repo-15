...
func (r CardFundingState) IsKnown() bool {
	switch r {
	case CardFundingStateEnabled, CardFundingStatePending, CardFundingStateDeleted:
		return true
	}
	return false
}
...
func (r CardSpendLimitDuration) IsKnown() bool {
	switch r {
	case CardSpendLimitDurationAnnually, CardSpendLimitDurationForever, CardSpendLimitDurationMonthly, CardSpendLimitDurationTransaction:
		return true
	}
	return false
}
...
func (r CardType) IsKnown() bool {
	switch r {
	case CardTypeVirtual, CardTypePhysical, CardTypeMerchantLocked, CardTypeSingleUse:
		return true
	}
	return false
}
...
func (r CardNewParamsType) IsKnown() bool {
	switch r {
	case CardNewParamsTypeVirtual, CardNewParamsTypePhysical, CardNewParamsTypeMerchantLocked, CardNewParamsTypeSingleUse:
		return true
	}
	return false
}
...
func (r CardNewParamsShippingMethod) IsKnown() bool {
	switch r {
	case CardNewParamsShippingMethodStandard, CardNewParamsShippingMethodStandardWithTracking, CardNewParamsShippingMethodPriority, CardNewParamsShippingMethodExpress, CardNewParamsShippingMethod2Day, CardNewParamsShippingMethodExpedited:
		return true
	}
	return false
}
...
func (r CardNewParamsSpendLimitDuration) IsKnown() bool {
	switch r {
	case CardNewParamsSpendLimitDurationAnnually, CardNewParamsSpendLimitDurationForever, CardNewParamsSpendLimitDurationMonthly, CardNewParamsSpendLimitDurationTransaction:
		return true
	}
	return false
}
...
func (r CardUpdateParamsSpendLimitDuration) IsKnown() bool {
	switch r {
	case CardUpdateParamsSpendLimitDurationAnnually, CardUpdateParamsSpendLimitDurationForever, CardUpdateParamsSpendLimitDurationMonthly, CardUpdateParamsSpendLimitDurationTransaction:
		return true
	}
	return false
}
