...
func (r *AnalyticsReportBytimeService) Get(ctx context.Context, zoneID string, query AnalyticsReportBytimeGetParams, opts ...option.RequestOption) (res *ByTime, err error) {
