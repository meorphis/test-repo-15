...
func (r *FirewallAnalyticsReportBytimeService) Get(ctx context.Context, accountID string, dnsFirewallID string, query FirewallAnalyticsReportBytimeGetParams, opts ...option.RequestOption) (res *ByTime, err error) {
