...
func (r *BrandProtectionService) Submit(ctx context.Context, accountID string, body BrandProtectionSubmitParams, opts ...option.RequestOption) (res *Submit, err error) {
...
func (r *BrandProtectionService) URLInfo(ctx context.Context, accountID string, query BrandProtectionURLInfoParams, opts ...option.RequestOption) (res *Info, err error) {
