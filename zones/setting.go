...
func (r *SettingService) Edit(ctx context.Context, zoneID string, settingID string, body SettingEditParams, opts ...option.RequestOption) (res *SettingEditResponse, err error) {
...
func (r *SettingService) Get(ctx context.Context, zoneID string, settingID string, opts ...option.RequestOption) (res *SettingGetResponse, err error) {
