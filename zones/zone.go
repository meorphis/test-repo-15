...
func (r *ZoneService) Edit(ctx context.Context, zoneID string, body ZoneEditParams, opts ...option.RequestOption) (res *Zone, err error) {
...
// Zone Details
func (r *ZoneService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *Zone, err error) {
