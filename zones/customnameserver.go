...
func (r *CustomNameserverService) Update(ctx context.Context, zoneID string, body CustomNameserverUpdateParams, opts ...option.RequestOption) (res *[]CustomNameserverUpdateResponse, err error) {
...
func (r *CustomNameserverService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *[]CustomNameserverGetResponse, err error) {
