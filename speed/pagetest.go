...
func (r *PageTestService) New(ctx context.Context, zoneID string, url string, body PageTestNewParams, opts ...option.RequestOption) (res *Test, err error) {
...
func (r *PageTestService) List(ctx context.Context, zoneID string, url string, query PageTestListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[Test], err error) {
...
// Test history (list of tests) for a specific webpage.
func (r *PageTestService) ListAutoPaging(ctx context.Context, zoneID string, url string, query PageTestListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[Test] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, zoneID, url, query, opts...))
}

// Deletes all tests for a specific webpage from a specific region. Deleted tests
// are still counted as part of the quota.
func (r *PageTestService) Delete(ctx context.Context, zoneID string, url string, body PageTestDeleteParams, opts ...option.RequestOption) (res *PageTestDeleteResponse, err error) {
...
func (r *PageTestService) Get(ctx context.Context, zoneID string, url string, testID string, opts ...option.RequestOption) (res *Test, err error) {
