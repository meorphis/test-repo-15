...
func (r *PageService) List(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *pagination.SinglePage[PageListResponse], err error) {
...
// Lists all webpages which have been tested.
func (r *PageService) ListAutoPaging(ctx context.Context, zoneID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[PageListResponse] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, opts...))
}

// Lists the core web vital metrics trend over time for a specific page.
func (r *PageService) Trend(ctx context.Context, zoneID string, url string, query PageTrendParams, opts ...option.RequestOption) (res *Trend, err error) {
