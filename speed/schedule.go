...
func (r *ScheduleService) New(ctx context.Context, zoneID string, url string, body ScheduleNewParams, opts ...option.RequestOption) (res *ScheduleNewResponse, err error) {
...
func (r *ScheduleService) Delete(ctx context.Context, zoneID string, url string, body ScheduleDeleteParams, opts ...option.RequestOption) (res *ScheduleDeleteResponse, err error) {
...
func (r *ScheduleService) Get(ctx context.Context, zoneID string, url string, query ScheduleGetParams, opts ...option.RequestOption) (res *Schedule, err error) {
