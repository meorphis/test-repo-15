...
func (r *MemberService) New(ctx context.Context, accountID string, body MemberNewParams, opts ...option.RequestOption) (res *MemberNewResponse, err error) {
...
func (r *MemberService) Update(ctx context.Context, accountID string, memberID string, body MemberUpdateParams, opts ...option.RequestOption) (res *MemberUpdateResponse, err error) {
...
func (r *MemberService) List(ctx context.Context, accountID string, query MemberListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[MemberListResponse], err error) {
...
// List all members of an account.
func (r *MemberService) ListAutoPaging(ctx context.Context, accountID string, query MemberListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[MemberListResponse] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, accountID, query, opts...))
}

// Remove a member from an account.
func (r *MemberService) Delete(ctx context.Context, accountID string, memberID string, opts ...option.RequestOption) (res *MemberDeleteResponse, err error) {
...
func (r *MemberService) Get(ctx context.Context, accountID string, memberID string, opts ...option.RequestOption) (res *MemberGetResponse, err error) {
