...
func (r *SettingTLSService) Update(ctx context.Context, zoneID string, settingID SettingTLSUpdateParamsSettingID, hostname string, body SettingTLSUpdateParams, opts ...option.RequestOption) (res *Setting, err error) {
...
func (r *SettingTLSService) Delete(ctx context.Context, zoneID string, settingID SettingTLSDeleteParamsSettingID, hostname string, opts ...option.RequestOption) (res *SettingTLSDeleteResponse, err error) {
...
func (r *SettingTLSService) Get(ctx context.Context, zoneID string, settingID SettingTLSGetParamsSettingID, opts ...option.RequestOption) (res *[]SettingTLSGetResponse, err error) {
