...
func (r *CacheReserveService) Clear(ctx context.Context, zoneID string, body CacheReserveClearParams, opts ...option.RequestOption) (res *CacheReserveClearResponse, err error) {
...
func (r *CacheReserveService) Edit(ctx context.Context, zoneID string, body CacheReserveEditParams, opts ...option.RequestOption) (res *CacheReserveEditResponse, err error) {
...
// You cannot re-enable Cache Reserve while this process is ongoing. Keep in mind
// that you cannot undo or cancel this operation.
func (r *CacheReserveService) Status(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *CacheReserveStatusResponse, err error) {
