...
func (r *SmartTieredCacheService) Delete(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *SmartTieredCacheDeleteResponse, err error) {
...
func (r *SmartTieredCacheService) Edit(ctx context.Context, zoneID string, body SmartTieredCacheEditParams, opts ...option.RequestOption) (res *SmartTieredCacheEditResponse, err error) {
...
func (r *SmartTieredCacheService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *SmartTieredCacheGetResponse, err error) {
