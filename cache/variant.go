...
func (r *VariantService) Delete(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *CacheVariant, err error) {
...
// does not serve the variant requested, the response will not be cached. This will
// be indicated with BYPASS cache status in the response headers.
func (r *VariantService) Edit(ctx context.Context, zoneID string, body VariantEditParams, opts ...option.RequestOption) (res *VariantEditResponse, err error) {
...
// does not serve the variant requested, the response will not be cached. This will
// be indicated with BYPASS cache status in the response headers.
func (r *VariantService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *VariantGetResponse, err error) {
