...
// topologies.
func (r *RegionalTieredCacheService) Edit(ctx context.Context, zoneID string, body RegionalTieredCacheEditParams, opts ...option.RequestOption) (res *RegionalTieredCacheEditResponse, err error) {
...
// upper tier. This can help improve performance for smart and custom tiered cache
// topologies.
func (r *RegionalTieredCacheService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *RegionalTieredCacheGetResponse, err error) {
