...
func TestSmartTieredCacheDelete(t *testing.T) {
	...
	_, err := client.Cache.SmartTieredCache.Delete(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
...
func TestSmartTieredCacheEdit(t *testing.T) {
	...
	_, err := client.Cache.SmartTieredCache.Edit(
		context.TODO(),
...
func TestSmartTieredCacheGet(t *testing.T) {
	...
	_, err := client.Cache.SmartTieredCache.Get(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
