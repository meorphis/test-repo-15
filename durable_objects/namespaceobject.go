...
func (r *NamespaceObjectService) List(ctx context.Context, accountID string, id string, query NamespaceObjectListParams, opts ...option.RequestOption) (res *pagination.CursorLimitPagination[DurableObject], err error) {
...
// Returns the Durable Objects in a given namespace.
func (r *NamespaceObjectService) ListAutoPaging(ctx context.Context, accountID string, id string, query NamespaceObjectListParams, opts ...option.RequestOption) *pagination.CursorLimitPaginationAutoPager[DurableObject] {
	return pagination.NewCursorLimitPaginationAutoPager(r.List(ctx, accountID, id, query, opts...))
}
