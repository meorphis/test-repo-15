...
func (r *OperationService) New(ctx context.Context, zoneID string, body OperationNewParams, opts ...option.RequestOption) (res *[]APIShield, err error) {
...
func (r *OperationService) List(ctx context.Context, zoneID string, query OperationListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[OperationListResponse], err error) {
...
// Retrieve information about all operations on a zone
func (r *OperationService) ListAutoPaging(ctx context.Context, zoneID string, query OperationListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[OperationListResponse] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, zoneID, query, opts...))
}

// Delete an operation
func (r *OperationService) Delete(ctx context.Context, zoneID string, operationID string, opts ...option.RequestOption) (res *OperationDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if zoneID == "" {
		err = errors.New("missing required zone_id parameter")
		return
...
func (r *OperationService) Get(ctx context.Context, zoneID string, operationID string, query OperationGetParams, opts ...option.RequestOption) (res *OperationGetResponse, err error) {
