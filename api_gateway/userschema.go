...
func (r *UserSchemaService) New(ctx context.Context, zoneID string, body UserSchemaNewParams, opts ...option.RequestOption) (res *SchemaUpload, err error) {
...
func (r *UserSchemaService) List(ctx context.Context, zoneID string, query UserSchemaListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[PublicSchema], err error) {
...
// Retrieve information about all schemas on a zone
func (r *UserSchemaService) ListAutoPaging(ctx context.Context, zoneID string, query UserSchemaListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[PublicSchema] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, zoneID, query, opts...))
}

// Delete a schema
func (r *UserSchemaService) Delete(ctx context.Context, zoneID string, schemaID string, opts ...option.RequestOption) (res *UserSchemaDeleteResponseUnion, err error) {
...
func (r *UserSchemaService) Edit(ctx context.Context, zoneID string, schemaID string, body UserSchemaEditParams, opts ...option.RequestOption) (res *PublicSchema, err error) {
...
func (r *UserSchemaService) Get(ctx context.Context, zoneID string, schemaID string, query UserSchemaGetParams, opts ...option.RequestOption) (res *PublicSchema, err error) {
