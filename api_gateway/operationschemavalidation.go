...
func (r *OperationSchemaValidationService) Update(ctx context.Context, zoneID string, operationID string, body OperationSchemaValidationUpdateParams, opts ...option.RequestOption) (res *OperationSchemaValidationUpdateResponse, err error) {
...
func (r *OperationSchemaValidationService) Edit(ctx context.Context, zoneID string, body OperationSchemaValidationEditParams, opts ...option.RequestOption) (res *SettingsMultipleRequest, err error) {
...
func (r *OperationSchemaValidationService) Get(ctx context.Context, zoneID string, operationID string, opts ...option.RequestOption) (res *OperationSchemaValidationGetResponse, err error) {
	opts = append(r.Options[:], opts...)
	if zoneID == "" {
		err = errors.New("missing required zone_id parameter")
		return
