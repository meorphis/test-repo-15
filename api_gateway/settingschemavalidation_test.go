...
func TestSettingSchemaValidationUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.APIGateway.Settings.SchemaValidation.Update(
		context.TODO(),
...
func TestSettingSchemaValidationEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.APIGateway.Settings.SchemaValidation.Edit(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		api_gateway.SettingSchemaValidationEditParams{
...
func TestSettingSchemaValidationGet(t *testing.T) {
	...
	_, err := client.APIGateway.Settings.SchemaValidation.Get(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
