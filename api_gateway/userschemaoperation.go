...
func (r *UserSchemaOperationService) List(ctx context.Context, zoneID string, schemaID string, query UserSchemaOperationListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[UserSchemaOperationListResponse], err error) {
...
// Retrieves all operations from the schema. Operations that already exist in API
// Shield Endpoint Management will be returned as full operations.
func (r *UserSchemaOperationService) ListAutoPaging(ctx context.Context, zoneID string, schemaID string, query UserSchemaOperationListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[UserSchemaOperationListResponse] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, zoneID, schemaID, query, opts...))
}
