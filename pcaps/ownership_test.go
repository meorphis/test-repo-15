...
func TestOwnershipNew(t *testing.T) {
	...
	_, err := client.PCAPs.Ownership.New(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		pcaps.OwnershipNewParams{
...
func TestOwnershipGet(t *testing.T) {
	...
	_, err := client.PCAPs.Ownership.Get(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestOwnershipValidate(t *testing.T) {
	...
	_, err := client.PCAPs.Ownership.Validate(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		pcaps.OwnershipValidateParams{
			DestinationConf:    cloudflare.F("s3://pcaps-bucket?region=us-east-1"),
