...
func (r *ResourceGroupService) New(ctx context.Context, accountID string, body ResourceGroupNewParams, opts ...option.RequestOption) (res *ResourceGroupNewResponse, err error) {
...
func (r *ResourceGroupService) Update(ctx context.Context, accountID string, resourceGroupID string, body ResourceGroupUpdateParams, opts ...option.RequestOption) (res *ResourceGroupUpdateResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
func (r *ResourceGroupService) List(ctx context.Context, accountID string, query ResourceGroupListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[ResourceGroupListResponse], err error) {
...
// List all the resource groups for an account.
func (r *ResourceGroupService) ListAutoPaging(ctx context.Context, accountID string, query ResourceGroupListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[ResourceGroupListResponse] {
	return pagination.NewV4PagePaginationArrayAutoPager(r.List(ctx, accountID, query, opts...))
}

// Remove a resource group from an account.
func (r *ResourceGroupService) Delete(ctx context.Context, accountID string, resourceGroupID string, opts ...option.RequestOption) (res *ResourceGroupDeleteResponse, err error) {
...
func (r *ResourceGroupService) Get(ctx context.Context, accountID string, resourceGroupID string, opts ...option.RequestOption) (res *ResourceGroupGetResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
