...
func (r *PolicyService) New(ctx context.Context, accountID string, body PolicyNewParams, opts ...option.RequestOption) (res *PolicyNewResponse, err error) {
...
func (r *PolicyService) Update(ctx context.Context, accountID string, policyID string, body PolicyUpdateParams, opts ...option.RequestOption) (res *PolicyUpdateResponse, err error) {
...
func (r *PolicyService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[Policy], err error) {
...
// Get a list of all Notification policies.
func (r *PolicyService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Policy] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, opts...))
}

// Delete a Notification policy.
func (r *PolicyService) Delete(ctx context.Context, accountID string, policyID string, opts ...option.RequestOption) (res *PolicyDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
func (r *PolicyService) Get(ctx context.Context, accountID string, policyID string, opts ...option.RequestOption) (res *Policy, err error) {
