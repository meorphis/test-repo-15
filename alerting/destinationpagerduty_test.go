...
func TestDestinationPagerdutyNew(t *testing.T) {
	...
	_, err := client.Alerting.Destinations.Pagerduty.New(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
...
func TestDestinationPagerdutyDelete(t *testing.T) {
	...
	_, err := client.Alerting.Destinations.Pagerduty.Delete(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestDestinationPagerdutyGet(t *testing.T) {
	...
	_, err := client.Alerting.Destinations.Pagerduty.Get(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cloudflare.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
