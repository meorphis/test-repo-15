...
func (r *DestinationPagerdutyService) New(ctx context.Context, accountID string, opts ...option.RequestOption) (res *DestinationPagerdutyNewResponse, err error) {
...
func (r *DestinationPagerdutyService) Delete(ctx context.Context, accountID string, opts ...option.RequestOption) (res *DestinationPagerdutyDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
func (r *DestinationPagerdutyService) Get(ctx context.Context, accountID string, opts ...option.RequestOption) (res *[]Pagerduty, err error) {
...
func (r *DestinationPagerdutyService) Link(ctx context.Context, accountID string, tokenID string, opts ...option.RequestOption) (res *DestinationPagerdutyLinkResponse, err error) {
