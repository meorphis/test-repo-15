...
// = 30, biz = 30, ent = 90).
func (r *HistoryService) List(ctx context.Context, accountID string, query HistoryListParams, opts ...option.RequestOption) (res *pagination.V4PagePaginationArray[History], err error) {
...
// are displayed for last `x` number of days based on the zone plan (free = 30, pro
// = 30, biz = 30, ent = 90).
func (r *HistoryService) ListAutoPaging(ctx context.Context, accountID string, query HistoryListParams, opts ...option.RequestOption) *pagination.V4PagePaginationArrayAutoPager[History] {
