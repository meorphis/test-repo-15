...
func (r *AssociationService) Get(ctx context.Context, accountID string, mtlsCertificateID string, opts ...option.RequestOption) (res *[]CertificateAsssociation, err error) {
