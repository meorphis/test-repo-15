...
// Put Snippet
func (r *SnippetService) Update(ctx context.Context, zoneID string, snippetName string, body SnippetUpdateParams, opts ...option.RequestOption) (res *Snippet, err error) {
...
// All Snippets
func (r *SnippetService) List(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *pagination.SinglePage[Snippet], err error) {
...
// All Snippets
func (r *SnippetService) ListAutoPaging(ctx context.Context, zoneID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Snippet] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, opts...))
}

// Delete Snippet
func (r *SnippetService) Delete(ctx context.Context, zoneID string, snippetName string, opts ...option.RequestOption) (res *SnippetDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if zoneID == "" {
		err = errors.New("missing required zone_id parameter")
		return
...
// Snippet
func (r *SnippetService) Get(ctx context.Context, zoneID string, snippetName string, opts ...option.RequestOption) (res *Snippet, err error) {
