...
func (r *TieredCachingService) Edit(ctx context.Context, zoneID string, body TieredCachingEditParams, opts ...option.RequestOption) (res *TieredCachingEditResponse, err error) {
...
func (r *TieredCachingService) Get(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *TieredCachingGetResponse, err error) {
