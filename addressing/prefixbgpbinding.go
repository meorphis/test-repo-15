...
func (r *PrefixBGPBindingService) New(ctx context.Context, accountID string, prefixID string, body PrefixBGPBindingNewParams, opts ...option.RequestOption) (res *ServiceBinding, err error) {
...
func (r *PrefixBGPBindingService) List(ctx context.Context, accountID string, prefixID string, opts ...option.RequestOption) (res *pagination.SinglePage[ServiceBinding], err error) {
...
// CDN would route traffic for `192.0.2.1` to the CDN, and traffic for all other
// IPs in the prefix to Cloudflare Magic Transit.
func (r *PrefixBGPBindingService) ListAutoPaging(ctx context.Context, accountID string, prefixID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[ServiceBinding] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, prefixID, opts...))
}

// Delete a Service Binding
func (r *PrefixBGPBindingService) Delete(ctx context.Context, accountID string, prefixID string, bindingID string, opts ...option.RequestOption) (res *PrefixBGPBindingDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
func (r *PrefixBGPBindingService) Get(ctx context.Context, accountID string, prefixID string, bindingID string, opts ...option.RequestOption) (res *ServiceBinding, err error) {
