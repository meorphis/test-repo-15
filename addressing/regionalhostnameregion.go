...
func (r *RegionalHostnameRegionService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[RegionalHostnameRegionListResponse], err error) {
...
// List all Regional Services regions available for use by this account.
func (r *RegionalHostnameRegionService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[RegionalHostnameRegionListResponse] {
