...
func (r *AddressMapIPService) Update(ctx context.Context, accountID string, addressMapID string, ipAddress string, body AddressMapIPUpdateParams, opts ...option.RequestOption) (res *[]AddressMapIPUpdateResponse, err error) {
...
func (r *AddressMapIPService) Delete(ctx context.Context, accountID string, addressMapID string, ipAddress string, opts ...option.RequestOption) (res *[]AddressMapIPDeleteResponse, err error) {
