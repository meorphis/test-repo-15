...
func (r *PrefixDelegationService) New(ctx context.Context, accountID string, prefixID string, body PrefixDelegationNewParams, opts ...option.RequestOption) (res *Delegations, err error) {
...
func (r *PrefixDelegationService) List(ctx context.Context, accountID string, prefixID string, opts ...option.RequestOption) (res *pagination.SinglePage[Delegations], err error) {
...
// List all delegations for a given account IP prefix.
func (r *PrefixDelegationService) ListAutoPaging(ctx context.Context, accountID string, prefixID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[Delegations] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, prefixID, opts...))
}

// Delete an account delegation for a given IP prefix.
func (r *PrefixDelegationService) Delete(ctx context.Context, accountID string, prefixID string, delegationID string, opts ...option.RequestOption) (res *PrefixDelegationDeleteResponse, err error) {
