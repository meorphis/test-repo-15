...
func (r *RegionalHostnameService) New(ctx context.Context, zoneID string, body RegionalHostnameNewParams, opts ...option.RequestOption) (res *RegionalHostnameNewResponse, err error) {
...
func (r *RegionalHostnameService) List(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *pagination.SinglePage[RegionalHostnameListResponse], err error) {
...
// List all Regional Hostnames within a zone.
func (r *RegionalHostnameService) ListAutoPaging(ctx context.Context, zoneID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[RegionalHostnameListResponse] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, opts...))
}

// Delete the region configuration for a specific Regional Hostname.
func (r *RegionalHostnameService) Delete(ctx context.Context, zoneID string, hostname string, opts ...option.RequestOption) (res *RegionalHostnameDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if zoneID == "" {
		err = errors.New("missing required zone_id parameter")
		return
...
func (r *RegionalHostnameService) Edit(ctx context.Context, zoneID string, hostname string, body RegionalHostnameEditParams, opts ...option.RequestOption) (res *RegionalHostnameEditResponse, err error) {
...
func (r *RegionalHostnameService) Get(ctx context.Context, zoneID string, hostname string, opts ...option.RequestOption) (res *RegionalHostnameGetResponse, err error) {
