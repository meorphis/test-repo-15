...
// Prefixes.
func (r *PrefixBGPPrefixService) List(ctx context.Context, accountID string, prefixID string, opts ...option.RequestOption) (res *pagination.SinglePage[BGPPrefix], err error) {
...
// advertise subnets more specific than an IP Prefix by creating more specific BGP
// Prefixes.
func (r *PrefixBGPPrefixService) ListAutoPaging(ctx context.Context, accountID string, prefixID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[BGPPrefix] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, accountID, prefixID, opts...))
}

// Update the properties of a BGP Prefix, such as the on demand advertisement
// status (advertised or withdrawn).
func (r *PrefixBGPPrefixService) Edit(ctx context.Context, accountID string, prefixID string, bgpPrefixID string, body PrefixBGPPrefixEditParams, opts ...option.RequestOption) (res *BGPPrefix, err error) {
...
func (r *PrefixBGPPrefixService) Get(ctx context.Context, accountID string, prefixID string, bgpPrefixID string, opts ...option.RequestOption) (res *BGPPrefix, err error) {
