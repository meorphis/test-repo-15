...
func (r *AddressMapService) New(ctx context.Context, accountID string, body AddressMapNewParams, opts ...option.RequestOption) (res *AddressMapNewResponse, err error) {
...
func (r *AddressMapService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *pagination.SinglePage[AddressMap], err error) {
...
// List all address maps owned by the account.
func (r *AddressMapService) ListAutoPaging(ctx context.Context, accountID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[AddressMap] {
...
func (r *AddressMapService) Delete(ctx context.Context, accountID string, addressMapID string, opts ...option.RequestOption) (res *[]AddressMapDeleteResponse, err error) {
...
func (r *AddressMapService) Edit(ctx context.Context, accountID string, addressMapID string, body AddressMapEditParams, opts ...option.RequestOption) (res *AddressMap, err error) {
...
func (r *AddressMapService) Get(ctx context.Context, accountID string, addressMapID string, opts ...option.RequestOption) (res *AddressMapGetResponse, err error) {
