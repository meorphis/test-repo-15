...
func (r *HostnameCertificateService) New(ctx context.Context, zoneID string, body HostnameCertificateNewParams, opts ...option.RequestOption) (res *HostnameCertificateNewResponse, err error) {
...
// List Certificates
func (r *HostnameCertificateService) List(ctx context.Context, zoneID string, opts ...option.RequestOption) (res *pagination.SinglePage[AuthenticatedOriginPull], err error) {
...
// List Certificates
func (r *HostnameCertificateService) ListAutoPaging(ctx context.Context, zoneID string, opts ...option.RequestOption) *pagination.SinglePageAutoPager[AuthenticatedOriginPull] {
	return pagination.NewSinglePageAutoPager(r.List(ctx, zoneID, opts...))
}

// Delete Hostname Client Certificate
func (r *HostnameCertificateService) Delete(ctx context.Context, zoneID string, certificateID string, opts ...option.RequestOption) (res *HostnameCertificateDeleteResponse, err error) {
...
func (r *HostnameCertificateService) Get(ctx context.Context, zoneID string, certificateID string, opts ...option.RequestOption) (res *HostnameCertificateGetResponse, err error) {
