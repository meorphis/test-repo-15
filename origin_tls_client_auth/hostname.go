...
func (r *HostnameService) Update(ctx context.Context, zoneID string, body HostnameUpdateParams, opts ...option.RequestOption) (res *[]AuthenticatedOriginPull, err error) {
...
func (r *HostnameService) Get(ctx context.Context, zoneID string, hostname string, opts ...option.RequestOption) (res *AuthenticatedOriginPull, err error) {
